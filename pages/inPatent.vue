    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>新增专利</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form-box">
                ...
                <el-form ref="form" :label-position="labelPosition" :inline="false" :model="form" label-width="150px">
                    <el-form-item label="专利名称">
                        <el-input v-model="form.patent_name" placeholder="专利名称"></el-input>
                    </el-form-item>
                    <el-form-item label="专利号">
                        <el-input v-model="form.patent_num" placeholder="正确格式如：ZL200810000001.1"></el-input>
                    </el-form-item>
                    <el-form-item label="专利类型">
                        <el-select v-model="form.patent_category" placeholder="请选择专利类型">
                          <el-option label="..." value="..."></el-option>
                          <el-option label="其他" value="其他"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="发明人">
                        <el-input v-model="form.inventor" placeholder="发明人"></el-input>
                    </el-form-item>
                    <el-form-item label="是否独立完成">
                        <el-input v-model="form.independence" placeholder="是否独立完成"></el-input>
                    </el-form-item>
                    <el-form-item label="完成单位">
                        <el-input v-model="form.department" placeholder="完成单位"></el-input>
                    </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            onCancel () {
                ...
                .then(_ => { // 点击确认，重置
                    this.form.patent_name = '',
                    this.form.patent_num = '',
                    this.form.patent_category = '',
                    this.form.inventor = '',
